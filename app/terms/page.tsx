        ...
        <div className="prose prose-gray max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              By downloading, installing, or using Dately (&quot;the App&quot;), you agree to be bound by these Terms of Service.
              If you do not agree to these terms, please do not use the App. Dately is operated by STAVHOPP.NO LLC (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;).
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Dately is a mobile application designed to help couples discover and plan date activities.
              The App uses artificial intelligence to generate personalized date ideas based on user preferences,
              location, and other factors. We also provide information about local venues, events, and activities.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Dately offers subscription plans (&quot;Dately Pro&quot;) that provide access to premium features:
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">5. Free Trial</h2>
            <p className="text-gray-700 leading-relaxed">
              We may offer free trial periods for Dately Pro. If you do not cancel before the trial ends,
              you will be automatically charged the subscription fee. Free trial eligibility is determined
              by Apple and may only be available once per Apple ID.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              You retain ownership of any content you submit to the App (such as photos and notes).
              By submitting content, you grant us a non-exclusive, worldwide, royalty-free license to use,
              store, and display your content solely for the purpose of providing the App&apos;s services to you.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              The App may display information from third-party services (such as venue details, reviews, and event information).
              We do not control and are not responsible for the accuracy of this information.
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              We do not guarantee the accuracy, completeness, or reliability of date suggestions,
              venue information, or any other content provided through the App.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Our total liability shall not exceed the amount you paid for Dately Pro in the past 12 months.
            </p>
          </section>
